namespace L08_2_FlowerMeadow {
    ...
    */
    ...
    let heigth: number = window.innerHeight;
    ...
    function createClouds(_x: number, _y: number): void {
        console.log("clouds");
        crc2.restore();
        crc2.save();
        crc2.translate(_x, _y);
    ...
    function createMountains(_x: number, _y: number, _i: number): void {
    ...
    function createFlowers(_x: number, _y: number, _i: number): void {
        console.log("flowers");
        crc2.restore();
        crc2.save();
        crc2.translate(_x, _y);
    ...
    function createTulips(_x: number, _y: number): void {
        console.log("tulips");
        crc2.restore();
        crc2.save();
        crc2.translate(_x, _y);
