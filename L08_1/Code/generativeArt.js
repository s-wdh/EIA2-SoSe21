...
(function (L08_1_GenerativeArt) {
    ...
    function createConfetti(_x, _y, _i) {
        crc2.restore();
        crc2.save();
        crc2.translate(_x, _y);
        if (_i < 150) {
    ...
    function createCircles(_x, _y, _i) {
        // create scale factor
        let scaleFactor = Math.floor(Math.random() * 5);
        // create gradients
        let linearGradient = crc2.createLinearGradient((-10 * scaleFactor), (-10 * scaleFactor), (10 * scaleFactor), (10 * scaleFactor));
        linearGradient.addColorStop(0.1, "#00ff11");
        linearGradient.addColorStop(0.8, "#ff6e00");
        let radialGradient = crc2.createRadialGradient(0, 0, 2, 0, 0, (10 * scaleFactor));
    ...
    function createPolygons(_x, _y) {
        // create random Color :)
        let colorRedValue = Math.floor(Math.random() * 256);
        let redString = colorRedValue.toString();
        let colorGreenValue = Math.floor(Math.random() * 256);
        let greenString = colorGreenValue.toString();
        let colorBlueValue = Math.floor(Math.random() * 256);
        let blueString = colorBlueValue.toString();
        let rgbCode = "rgba(" + redString + ", " + greenString + ", " + blueString + ", 1)";
        crc2.restore();
        crc2.save();
        crc2.translate(_x, _y);
    ...
    function createEmptySpaces(_x, _y) {
        crc2.restore();
        crc2.save();
        crc2.clearRect(_x, _y, 50, 50);
        crc2.restore();
    }
})(L08_1_GenerativeArt || (L08_1_GenerativeArt = {})); // namespace
